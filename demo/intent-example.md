...
- [x] One `.view.lkml` file for every table in `gold_marts`
- [x] `models/gold_marts.model.lkml` with explores for each primary entity
- [x] Every view has a `count` measure
- [x] Sum/average measures on revenue, profit, and quantity columns
- [x] Handoff log entry written with connection placeholder noted
- [x] No hardcoded credentials in any LookML file
